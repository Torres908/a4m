  ...
  if(isset($_POST['submit'])){
      ...
      if($result->num_rows >= 5){
        $error_msg = "Max events at a time is 5";
				...
				$sql = "INSERT INTO reservations (resNumber, custID, eventType, date, supplies1, supplies2, supplies3, supplies4, supplies5)
                 VALUES ($n, $id, '$eventType', '$eventDate', '$sup1', '$sup2', '$sup3', '$sup4', '$sup5')";
				if (mysqli_query($db, $sql)){
					$_SESSION['eventCreated'] = TRUE;
				 	header('Location: https://web.njit.edu/~jt398/a4m/newressuccess.php');
				 	exit;
				}else{
              ...
              <select name = "supplies5">
                ...
                <option value="decorations">
                  Decorations
					...
					<tr>
						<td>
							<input type = "button" value="Back" onclick="window.location.href='https://web.njit.edu/~jt398/a4m/ecpMain.php'"/>
						</td>
