<?php
  ...
  if(isset($_POST['test'])){
    ...
    if(mysqli_query($db, $sql)){
      ...
      $_SESSION['new'] = $new;
      header("Location: https://web.njit.edu/~jt398/a4m/updateSuccess.php");
      exit;
    }else{
...
<html>
	...
	<body>
		<div id = "main">
          ...
          <tr>
            <td><input type = "button" value="Cancel" onclick="window.location.href='https://web.njit.edu/~jt398/a4m/viewReservations.php'"/></td>
            <td></td>
